...
ThreadPool::ThreadPool(_In_ UINT8 NoThreads, _In_ Lock* Lock) : lock {Lock}
{
...
void ThreadPool::CleanupThreadPool()
{
    WaitThreads();
}

ThreadPoolWorkItem* ThreadPool::GetWorkerItem()
{
    LockGuard guard(lock);

...
)
{
    ...
    __try 
    {
        ProbeForWrite(ReadIrp->AssociatedIrp.SystemBuffer, sizeof(ULONG), 1);
        ProbeForRead(ReadIrp->AssociatedIrp.SystemBuffer, sizeof(ULONG), 1);

        *(PULONG)ReadIrp->AssociatedIrp.SystemBuffer = *(PULONG)WriteIrp->AssociatedIrp.SystemBuffer;
